  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Zitss's API</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="api/fbdown/?url=MASUKIN_URL&apikey=Apikey-Nya">Facebook Downloader</a>
            <a class="collapse-item" href="api/tiktod/?url=MASUKIN_URL&apikey=Apikey-Nya">Tiktok Downloader</a>
            <a class="collapse-item" href="api/tiktod/stalk/?username=MASUKIN_USERNAME&apikey=Apikey-Nya">Tiktok Stalk</a>
            </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div id="collapseGithub" class="collapse" aria-labelledby="headingGithub" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="api/randomquote?apikey=Apikey-Nya">Quotes</a>
            <a class="collapse-item" href="api/randomquote/muslim?apikey=Apikey-Nya">Quotes Islami</a>
            <a class="collapse-item" href="api/quotes/kanye?apikey=Apikey-Nya">Quotes Kanye</a>
            <a class="collapse-item" href="api/random/asmaulhusna?apikey=Apikey-Nya">Asmaul Husna</a>
            <a class="collapse-item" href="api/random/meme?apikey=Apikey-Nya">Meme</a>
            <a class="collapse-item" href="api/random/wallpaper?apikey=Apikey-Nya">Wallpaper</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
        ...
        <div id="collapseText" class="collapse" aria-labelledby="headingText" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="api/textmaker?text=halo&text2=hai&theme=glitch&apikey=Apikey-Nya">Glitch</a>
            <a class="collapse-item" href="api/textmaker?text=halo&text2=hai&text3=gwganteng&theme=google-suggestion&apikey=Apikey-Nya">Google Suggestion</a>
            <a class="collapse-item" href="api/textmaker/game?text=halo&text2=hai&theme=pubg&apikey=Apikey-Nya">PUBG</a>
            <a class="collapse-item" href="api/textmaker/game?text=halo&text2=hai&theme=battlefield&apikey=Apikey-Nya">BattleField</a>
            <a class="collapse-item" href="api/textmaker/senja?text=Zitsss&theme=coffee-cup&apikey=Apikey-Nya">Coffee Cup</a>
            <a class="collapse-item" href="api/textmaker/senja?text=Zitsss&theme=coffee-cup2&apikey=Apikey-Nya">Coffee Cup 2</a>
            <a class="collapse-item" href="api/textmaker/metallic?text=Zitsss&theme=neon&apikey=Apikey-Nya">Neon</a>
            <a class="collapse-item" href="api/textmaker/metallic?text=Zitsss&theme=glow&apikey=Apikey-Nya">Glow</a>
            <a class="collapse-item" href="api/textmaker/alam?text=Zitsss&theme=summer&apikey=Apikey-Nya">Summer</a>
            <a class="collapse-item" href="api/textmaker/alam?text=Zitsss&theme=flower&apikey=Apikey-Nya">Flower</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <div id="collapseother" class="collapse" aria-labelledby="headingother" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="api/infonpm?query=Zitsss-api&hostname=Zitsss&apikey=MASUKAN_APIKEY">Info NPM</a>
            <a class="collapse-item" href="api/infogempa?apikey=MASUKAN_APIKEY">Info Gempa</a>
            <a class="collapse-item" href="api/cuaca?kabupaten=kab bungo&apikey=MASUKAN_APIKEY">Info Cuaca</a>
...
<div class="version"><b>Contact me</b></div>
      ...
      <li class="nav-item">
            <a class="nav-link collapsed" href="https://github.com/Zitsss">
            <i class="fab fa-fw fa-github"></i>
                    <span>Github</span>
            </a>
      </li>
      <li class="nav-item">
            <a class="nav-link collapsed" href="https://instagram.com/zitsraa_">
            <i class="fab fa-fw fa-instagram"></i>
                    <span>Instagram</span>
            </a>
      </li>
      <hr class="sidebar-divider">
      <div class="version"><b>Made With By Zitsraa</b></div>
    </ul>
    <!-- Sidebar -->
                ...
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col mr-2">
                      ...
                      <br>
                      <div class="h5 mb-0 font-weight-bold text-gray-800">Zitsss</div>
                      <div class="mt-2 mb-0 text-muted text-xs">
                        <span class="text-success mr-2"> 13. y.o Programmer</span>
                      </div>
                    </div>
                    <div class="col-auto">
...
<div class="card-body">
          ...
          <div class="row">
            <div class="col-lg-12 text-center">
              <p>Suka Dengan API Nya ? Boleh Dong, Follow Github Gw : <a href="https://github.com/Zitss"
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; 2021 - Developed By
              <b><a href="https://github.com/Zitss" target="_blank">Zitss</a></b>
            </span>
          </div>
        </div>
      </footer>
